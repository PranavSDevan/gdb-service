package com.gdb.bankstatements.security;

import com.gdb.bankstatements.client.AuthClient;
...
public class SecurityFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(@NonNull HttpServletRequest request,
        ...
        if (path.contains("/v3/api-docs") || path.contains("/swagger-ui") || path.contains("/docs")
                || path.equals("/health")
