...
const PayCreditCardBill = () => {
  ...
  const loadData = async () => {
    try {
      ...
      if (cardData && cardData.minimumDue > 0) {
    ...
    return (
      <div className="max-w-3xl mx-auto space-y-6">
        ...
        <div className="text-center py-12 bg-white rounded-xl shadow-sm border border-gray-100">
          ...
          <p className="text-gray-500 mt-2">You need to have an active credit card to make payments. Please apply for a credit card first.</p>
          <button
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        {data?.outstandingAmount === 0 && (
          <div className="md:col-span-3 bg-green-50 border border-green-200 rounded-xl p-4 flex items-center gap-3">
            ...
            <div>
              <p className="font-semibold text-green-800">Outstanding Bill: {formatCurrency(0)}</p>
            ...
            <div className="p-6">
              <form onSubmit={handlePreviewSubmit} className="space-y-6">
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    >
                      ...
                      <option value="1001">Savings Account - 1001 ({formatCurrency(500000)})</option>
                      <option value="1002">Current Account - 1002 ({formatCurrency(1000000)})</option>
                    </select>
                  </div>
                  {touched.debitAccount && errors.debitAccount && (
                ...
                <div>
                  ...
                  <label className="block text-sm font-medium text-gray-700 mb-2">Or enter custom amount ({useSettingsStore.getState().currency}) *</label>
                  <div className="relative">
                    <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
